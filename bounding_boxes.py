...
from rpg_e2depth.carla.spawn_npc_thread import run
...
class BasicSynchronousClient(object):
    ...
    def game_loop(self):
        ...
        try:
            ...
            flags = FLAGS()
            cars_and_walkers = threading.Thread(target=run, args=(flags, self.client))
            ...
            peds = self.world.get_actors().filter('walker.*')
            print(peds)
