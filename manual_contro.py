...
try:
    sys.path.append('/opt/carla-simulator/PythonAPI/carla/dist/carla-0.9.11-py3.7-linux-x86_64.egg')
except IndexError:
    pass
...
sys.path.append('/home/owen/Documents/Python/rpg_e2depth/carla')
import spawn_npc_thread
...
def game_loop(args):
    ...
    try:
        ...
        spawn_args = FLAGS()
        cars_and_walkers = threading.Thread(target=spawn_npc_thread.run, args=(spawn_args, client))
